...
public class DatabaseConnectionImpl implements DatabaseConnection {
     ...
     * @param databaseServer - the database server to connect to
     * @param databaseServerPort - the database server port to connect to
     * @param databaseServerUser - the database user to use
     * @param databaseServerPassword- the database password to use
     */
    ...
    /**
     * This method logs erros while connecting to the database server.
     * @param exception - exception to be logged
     */
    protected void logDatabaseConnectionError (SQLException exception) {
        logError("Can't connect to database: ", exception);
    }
}
